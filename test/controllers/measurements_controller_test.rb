...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference("Measurement.count") do
      post measurements_url, params: { measurement: { date_taken: @measurement.date_taken, hip: @measurement.hip, user_id: @measurement.user_id, waist: @measurement.waist, weight: @measurement.weight } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { date_taken: @measurement.date_taken, hip: @measurement.hip, user_id: @measurement.user_id, waist: @measurement.waist, weight: @measurement.weight } }
